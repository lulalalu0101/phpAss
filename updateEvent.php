...
$eventCode = $_POST['update_id'];

// Check if the update button was pressed
if (isset($_POST['submit'])) {
     // Get the event code from the form
    ...
    $sql = "INSERT INTO `events` VALUES ('','$eventTitle','$eventDesc','$eventVenue','$eventCountry','$eventCity','$eventDate','$eventTime','$eventType','$limit','$price','$ogName','$ogContact','$ogMail') WHERE eventCode = $eventCode";
        
    $r = mysqli_query($con, $sql);
        // Execute the statement
        if (mysqli_stmt_execute($r)) {
            echo "<div class='message'>Updated Successfully. <a href='adminEvent.php'>Go Back</a></div>";
        } else {
